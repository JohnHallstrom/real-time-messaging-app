...
```bash
git remote add encore encore://real-time-messaging-app-or4i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/real-time-messaging-app-or4i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/real-time-messaging-app-or4i/settings/integrations/github)
