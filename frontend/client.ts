...
export namespace messages {
    ...
    export class ServiceClient {
         ...
         */
        public async list(params: RequestType<typeof api_messages_list_list>): Promise<ResponseType<typeof api_messages_list_list>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/messages/list`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_messages_list_list>
        }

        /**
         * Marks a message as read and starts the disappearing timer.
         */
        public async markRead(params: RequestType<typeof api_messages_mark_read_markRead>): Promise<ResponseType<typeof api_messages_mark_read_markRead>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/messages/mark-read`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_messages_mark_read_markRead>
        }

        /**
         * Sends a message to another user.
         */
        public async send(params: RequestType<typeof api_messages_send_send>): Promise<ResponseType<typeof api_messages_send_send>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/messages/send`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_messages_send_send>
        }
    }
}
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { chat as api_realtime_chat_chat } from "~backend/realtime/chat";
...
export namespace realtime {
    ...
    export class ServiceClient {
         ...
         */
        public async chat(): Promise<StreamInOut<StreamRequest<typeof api_realtime_chat_chat>, StreamResponse<typeof api_realtime_chat_chat>>> {
            return await this.baseClient.createStreamInOut(`/realtime/chat`)
        }
    }
}
...
export namespace users {
    ...
    export class ServiceClient {
        ...
        public async list(params: RequestType<typeof api_users_list_list>): Promise<ResponseType<typeof api_users_list_list>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/users/list`, {method: "POST", body: JSON.stringify(params)})
